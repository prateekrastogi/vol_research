...
2. **Data adapter** (Breeze — research + live), minute + per-strike options (incl. expired).
...
6. If it clears costs OOS → **paper trade** (Breeze) → small live on a fixed-IP VPS, SEBI-compliant.
